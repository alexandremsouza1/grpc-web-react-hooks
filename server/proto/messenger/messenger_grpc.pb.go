...
const (
	Messenger_GetMessages_FullMethodName   = "/messenger.Messenger/GetMessages"
	Messenger_CreateMessage_FullMethodName = "/messenger.Messenger/CreateMessage"
)
...
func (c *messengerClient) GetMessages(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (Messenger_GetMessagesClient, error) {
	stream, err := c.cc.NewStream(ctx, &Messenger_ServiceDesc.Streams[0], Messenger_GetMessages_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *messengerClient) CreateMessage(ctx context.Context, in *MessageRequest, opts ...grpc.CallOption) (*MessageResponse, error) {
	...
	err := c.cc.Invoke(ctx, Messenger_CreateMessage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Messenger_CreateMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Messenger_CreateMessage_FullMethodName,
	}
